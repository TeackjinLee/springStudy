...
<%@include file="../includes/header.jsp" %>
            ...
            <script type="text/javascript">
            	...
            	$(document).ready(function(){
           	    ...
           	    var paginateLinks = document.querySelectorAll(".paginate_button a");
           	    ...
           	    paginateLinks.forEach(function(link) {
           	 	...
           	 	var searchButton = document.querySelectorAll("#searchForm button");
				searchButton.forEach(function(button){
					button.addEventListener("click", function(e) {

						if(!searchForm.querySelector("option:checked").value) {
							console.log("---------------------");
							alert("검색종류를 선택하세요");
							return false;
						}
