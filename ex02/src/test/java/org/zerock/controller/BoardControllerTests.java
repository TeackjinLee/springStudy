...
@ContextConfiguration({
	"file:/Users/itaegjin/git/springStudy/ex02/src/main/webapp/WEB-INF/spring/root-context.xml",
	"file:/Users/itaegjin/git/springStudy/ex02/src/main/webapp/WEB-INF/spring/appServlet/servlet-context.xml"
})
@Log4j
public class BoardControllerTests {
	...
	public void testRegister() throws Exception {
		...
		String resultPage = mocMvc.perform(MockMvcRequestBuilders.post("/board/register")
				.param("title", "테스트2 새글 제")
				.param("content", "테스트2 새글 내용")
				.param("writer", "user01")
	...
	public void testModify() throws Exception {
		String resultPage = mocMvc
				.perform(MockMvcRequestBuilders.post("/board/modify")
						.param("bno", "2")
						.param("title", "수정된 테스트2 새글 제목")
						.param("content", "수정된 내용2 새글 내용")
						.param("writer", "user01"))
				.andReturn().getModelAndView().getViewName();
		log.info(resultPage);
	}
